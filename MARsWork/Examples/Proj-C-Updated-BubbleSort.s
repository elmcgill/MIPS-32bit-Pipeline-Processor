...
begin:
	...
	sll $zero, $zero, 0			  # 3 NOPs inserted because next instruction is a read
	sll $zero, $zero, 0			  # after write data dependency
	sll $zero, $zero, 0
...
main:
	...
	sll $zero, $zero, 0
	sll $zero, $zero, 0
    sub $5,$9,$1                # number of loops decrements after each iteration 
    sll $zero, $zero, 0			  # 3 NOPs inserted because next instruction is a read
	sll $zero, $zero, 0			  # after write data dependency
	sll $zero, $zero, 0 
